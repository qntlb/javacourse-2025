...
import com.alessandrosgarabottolo.session3.encapsulation.lazyinitialization.LinearCongruentialGenerator;
import com.alessandrosgarabottolo.session4.usefulmatrices.UsefulMethodsMatricesVectors;
 ...
 * provide the user with data he or she can be interested about: for example, the method getRealizations()
...
public class BinomialModelSimulator {
	...
	private double riskNeutralProbabilityUp; // it will be equal to (1 + interestRate - decreaseIfDown)/(increaseIfUp - decreaseIfDown) 
	...
	private void generateRealizations() {
		...
		// a first for loop to fill the first row
		for (int simulationIndex = 0; simulationIndex < numberOfSimulations; simulationIndex++) {

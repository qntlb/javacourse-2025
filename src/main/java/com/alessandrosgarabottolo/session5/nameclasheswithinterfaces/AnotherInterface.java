 ...
 * methods 
 * - In AnInterface a method void methodWithDifferentReturnTypes()
...
public interface AnotherInterface {
	...
	/*
	 * Same name and same argument list as in AnInterface! Uncomment the following
	 * line to see the error in NameClashes
	 */

 ...
 * return types! Why that? Because sometimes you call a method not (only) for what it returns,
 * but (also) for its side effect: you could write int a = object.foo(int i), or just
 * type object.foo(i). In that case, the compiler could not know which of the two methods it
 ...
 */
package com.alessandrosgarabottolo.session5.nameclasheswithinterfaces;
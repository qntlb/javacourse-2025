 ...
 * object calling the method itself. This is done by returning "this".
 ...
 * the same line, all for the same object. This way to construct an object is known as
 * Builder pattern, and uses the return of the reference to the object calling
...
public class Client {
	 ...
	 * the static method below is a bit more elegant
	 */
	Client(String id) {
		this.id = id;
	}

package com.alessandrosgarabottolo.session2.treesconstructor;
...
public class Tree {
	...
	// constructor with one argument of type double
	 ...
	 * Java will not do it for us, and calling the default constructor in the main we get an error.
	 */

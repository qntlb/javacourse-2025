package com.alessandrosgarabottolo.session2.divisions;
 ...
 * objects of the class where it is defined. We show the difference with a
 * non-static method.
 *
...
public class CalculatorTest {
	...
	public static void main(String[] args) {
		...
		double result = Calculator.computeRatio(newDividend, newDivisor); // called directly from the class

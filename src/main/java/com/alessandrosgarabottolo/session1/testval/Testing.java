...
public class Testing {
	...
	public static void main(String[] args) {
		...
		Comparison test = new Comparison(); // constructing an object of type Comparison
		...
		System.out.println("The result of the test as a boolean is: "
				+ test.isInside(testedNumber, leftEnd, rightEnd));
		// note: the method is called inside println
		
		System.out.println("\nThe result from the compact method is: "+ test.compactIsInside(testedNumber, leftEnd, rightEnd));

 ...
 * be changed: we don't want the user to be able to first set it to be an
 * int and then a double.
 * In this case, we can use generics: we write a T inside angle brackets after the name

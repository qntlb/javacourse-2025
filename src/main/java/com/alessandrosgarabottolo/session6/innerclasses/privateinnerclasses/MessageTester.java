package com.alessandrosgarabottolo.session6.innerclasses.privateinnerclasses;
...
public class MessageTester {
	...
	public static void main(String[] args) {
		...
		Message message = new Message("We are almost at the end");
		 ...
		 * from the user: the user does not even know the type the object returned
		 * by message.getAPrinter().
		 */

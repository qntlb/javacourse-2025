 ...
 * com.alessandrosgarabottolo.session6.exceptions.divisions: they are so common that if you had to do so, your code
 * would be too messy.
 * 
 ...
 */
package com.alessandrosgarabottolo.session6.exceptions.commonexception;